    ...
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      <div className="md:hidden flex justify-between items-center p-4 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          />
          <div className="hidden w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-400 to-blue-600 flex items-center justify-center font-bold text-white shadow-glow">
            S
          </div>
      ...
      <AnimatePresence>
        {(isSidebarOpen || window.innerWidth >= 768) && (
          ...
          >
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement!.innerHTML =
                      '<div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 flex items-center justify-center text-3xl font-bold text-white">S</div>';
                  }}
                />
              </motion.div>
              <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-white">
                SIMATSU
              </h1>
                ...
                return (
                  <Link
                    ...
                    className={`
                      ...
                      ${
                        isActive
                          ? 'bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-white border border-cyan-500/30 shadow-[0_0_15px_rgba(6,182,212,0.15)]'
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="activeNav"
                        className="absolute left-0 w-1 h-full bg-cyan-400 rounded-r-full"
                      />
                    )}
                  </Link>
                );
            ...
            {/* ⬇️ Bagian ini yang tadi kita ubah jadi Link ke /login */}
            <div className="p-4 border-t border-white/5">
              <Link
                to="/login"
                onClick={() => setIsSidebarOpen(false)}
                className="flex items-center gap-3 w-full p-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 text-white hover:shadow-lg hover:shadow-blue-500/30 transition-all group"
              >
                <UserCircle size={20} />
