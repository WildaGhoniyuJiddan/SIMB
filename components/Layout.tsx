    ...
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      <div className="md:hidden flex justify-between items-center p-4 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        <div className="flex items-center gap-2">
           <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-400 to-blue-600 flex items-center justify-center font-bold text-white shadow-glow">S</div>
          ...
          >
            <div className="p-8 flex flex-col items-center justify-center border-b border-white/5">
               <motion.div 
                 ...
                 className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 flex items-center justify-center shadow-[0_0_30px_rgba(56,189,248,0.5)] mb-4"
               >
