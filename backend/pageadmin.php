...
// URL dasar React-mu (dev): sesuaikan kalau nanti sudah di-deploy
$reactBaseUrl = 'http://localhost:3000/#';

// Redirect kalau belum login
if (!isset($_SESSION['admin_id'])) {
    header("Location: {$reactBaseUrl}/login");
    exit;
}

// Logout kalau ada ?logout=1
if (isset($_GET['logout'])) {
    $_SESSION = [];
    session_destroy();
    header("Location: {$reactBaseUrl}/");
    exit;
}
...
<div class="container mt-5 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-secondary">
            <i class="fas fa-water"></i> Manajemen Data Tsunami
        </h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-warning text-dark"><?= $row['magnitudo']; ?> SR</span>
                            </td>
...
<a href="?logout=1"
   class="btn btn-danger position-fixed bottom-0 start-0 m-4 shadow-lg"
   style="z-index: 1000; border-radius: 50px; padding: 10px 20px;">
